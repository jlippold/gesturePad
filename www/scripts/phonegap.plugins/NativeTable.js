...
(function(cordova) {
	...
	function NativeTable() {
		...
		this.toolbarCallBackFunction = null;
	...
	NativeTable.prototype.scrollTo = function(idx) {
		cordova.exec("NativeTable.scrollTo", idx);
	};
	...
	NativeTable.prototype.onToolbarButtonClick = function(callBkFunc) {
		this.toolbarCallBackFunction = callBkFunc;
	};

	NativeTable.prototype._onToolbarButtonClick = function(buttonIndex) {
		if (this.toolbarCallBackFunction)
			this.toolbarCallBackFunction(buttonIndex);
	};
